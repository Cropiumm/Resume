document
    .querySelectorAll(".header__navigation-container a") // Отримуємо всі посилання і проходимося по них циклом
    .forEach((anchor) => {
        anchor.addEventListener("click", function (e) {
            ...
            if (targetElement) {
                ...
                document
                    .querySelectorAll(".header__navigation-container a") // Збираємо всі посилання навігації на сторінці
                    .forEach((underline) => {
